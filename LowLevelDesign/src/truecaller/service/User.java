...
import truecaller.GlobalContacts;
import truecaller.exception.BlockLimitExceededException;
import truecaller.exception.ContactDoesNotExistsException;
import truecaller.exception.ContactsExceededException;
import truecaller.model.Account;
import truecaller.model.UserCategory;
import truecaller.model.common.Contact;
import truecaller.model.common.GlobalSpam;
...
import static truecaller.model.common.Constant.*;
...
public class User extends Account {
    ...
    private void insertToTries(String phoneNumber, String firstName) {
        ...
        GlobalContacts.getInstance().getContactTrie().insert(phoneNumber);
        GlobalContacts.getInstance().getContactTrie().insert(firstName);
    }
}
