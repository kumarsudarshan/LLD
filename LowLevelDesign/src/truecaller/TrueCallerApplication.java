...
public class TrueCallerApplication {
    public static void main(String[] args) throws ContactsExceededException, BlockLimitExceededException {
        ...
        names = GlobalContacts.getInstance().getContactTrie().allWordsWithPrefix("u2");
        for (String s: names){
            System.out.println(s);
        }

        System.out.println("******** Case2 Searching from global directory ******");
        names = GlobalContacts.getInstance().getContactTrie().allWordsWithPrefix("ram");
        for (String s: names){
            System.out.println(s);
        }

        System.out.println("******** Case3 Searching from global directory ******");
        names = GlobalContacts.getInstance().getContactTrie().allWordsWithPrefix("a");
        for (String s: names){
            System.out.println(s);
        }
    }
