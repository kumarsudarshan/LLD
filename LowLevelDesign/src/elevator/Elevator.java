        ...
        while (true) {
            ...
            if (checkIfJob()) {
                ...
                if (currentDirection == Direction.UP) {
                    Request request = currentJobs.pollFirst(); // pollFirst will return lowest floor that elevator can go
                ...
                if (currentDirection == Direction.DOWN) {
                    Request request = currentJobs.pollLast(); // pollLast will return highest floor that elevator can go
