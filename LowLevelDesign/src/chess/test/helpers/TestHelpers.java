package chess.test.helpers;

import chess.conditions.*;
import chess.model.*;
import chess.moves.*;
...
public class TestHelpers {
    ...
    public static Piece randomPiece() {
        return pawn(WHITE, VerticalMoveDirection.BOTH);
    }
    ...
    public static Piece king(Color color) {
        ImmutableList<PossibleMovesProvider> pawnMoveProviders = ImmutableList.of(
            new PossibleMovesProviderVertical(1, new NoMoveBaseCondition(), defaultMoveFurtherCondition(), defaultBaseBlocker(), VerticalMoveDirection.BOTH),
        ...
        return new Piece(color, pawnMoveProviders, PieceType.KING);
    }

    public static Piece queen(Color color) {
        ImmutableList<PossibleMovesProvider> pawnMoveProviders = ImmutableList.of(
                new PossibleMovesProviderVertical(8, new NoMoveBaseCondition(), defaultMoveFurtherCondition(), defaultBaseBlocker(), VerticalMoveDirection.BOTH),
        ...
        return new Piece(color, pawnMoveProviders, PieceType.QUEEN);
    }
    ...
    public static Piece rook(Color color) {
        ...
        return new Piece(color, pawnMoveProviders, PieceType.ROOK);
    }
    ...
    public static Piece bishop(Color color) {
        ...
        return new Piece(color, pawnMoveProviders, PieceType.BISHOP);
    }
    ...
    public static Piece knight(Color color) {
        ...
        return new Piece(color, pawnMoveProviders, PieceType.KNIGHT);
    }
