...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        final MQSubscriber sub1 = new MQSubscriber("sub1", 10000);
        final MQSubscriber sub2 = new MQSubscriber("sub2", 10000);
        queue.subscribe(sub1, topic1);
        queue.subscribe(sub2, topic1);

        final MQSubscriber sub3 = new MQSubscriber("sub3", 5000);
