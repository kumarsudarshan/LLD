...
public class DoublyLinkedListTest {
    ...
    void verifyDLL(DoublyLinkedList<Integer> dll, List<Integer> expectedListElements) {
        Assert.assertEquals(expectedListElements.get(expectedListElements.size() - 1), dll.getLastNode().getElement());
        Assert.assertEquals(expectedListElements.get(0), dll.getFirstNode().getElement());
        ...
        for (Integer expectedListElement : expectedListElements) {
            ...
            Assert.assertEquals(expectedListElement, currentNode.getElement());
            currentNode = currentNode.getNext();
        }
        Assert.assertNull(currentNode.getNext());
    }
}
